...
let duration = 5000;
// let str = ['QUE', 'A', 'SUA', 'IMAGINAÇÃO', 'SEJA', 'SUPERADA', 'POR', 'TANTAS', 'SURPRESAS', 'QUE', 'ESSE', 'ANO', 'LHE', 'RESERVA', '.', 'DAQUI', 'PARA', 'FRENTE', 'SERÁ', 'VOCÊ', 'A', 'COMANDAR', 'E', 'MOSTRAR', 'SUA', 'FORÇA', '.', 'FELIZ', '2023', 'DO', 'SEU', 'AMIGO', 'MARCELL'];
let str = ['FELIZ', '2023', 'SEU', 'AMIGO', 'MARCELL'];
